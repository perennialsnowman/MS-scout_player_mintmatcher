...
blockstart = 26200000
blockend = 26319340
api_key = '' #for polygonscan
contract_address = '0x28F49Ba7b20CAD0a8256BE34484cF733B0f9a88F'
polygon_node = '' #take your pick, I used a moralis speedy node
#######################################
...
abi_endpoint = f"https://api.polygonscan.com/api?module=contract&action=getabi&address=0x28F49Ba7b20CAD0a8256BE34484cF733B0f9a88F&apikey={api_key}"
